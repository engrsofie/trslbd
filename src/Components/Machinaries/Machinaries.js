    ...
    <div>
      <div className="Product">
        ...
        <div className="Item">
          <h6>
            {" "}
            <FaHome /> <FaChevronRight /> <span>Machinaries</span>{" "}
          </h6>
        </div>
        <div className="ProductHeading">
          ...
          <p className="container">
            ...
            efficient and deliver the best quality in shortest possible
            lead-time. Currently having 525 Jacquard Machine from 3gg to 12 gg.
          </p>
